  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 },
        uResolution: {
          value: new Color(gl.canvas.width || 1, gl.canvas.height || 1, (gl.canvas.width || 1) / (gl.canvas.height || 1))
        },
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      const y = 1.0 - (e.clientY - rect.top) / (rect.height || window.innerHeight || 1);
